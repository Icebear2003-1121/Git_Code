...
//    TCNT0++;
//        TCNT1++;
    if(GyroINT == 0) GyroINT = 1;
        DirectionControl();
//        Calculate_Offset();
        motor_allcontrol();
//        oled_show_int(106,0,gpt[0],3);
//        oled_show_int(106,1,gpt[1],3);

    //gpio_set_level(MOTORL_DIR, 1);//左轮0为正转
//    pwm_set_duty(MOTORL_PWM, 1000);

//    pwm_set_duty(MOTORR_PWM, 1000);
//    oled_show_int(56,3,MOTORR_DIR,3);
//    gpio_set_level(MOTORR_DIR, 1);//右轮1为正转
...
//        if(1)
//                    {
//                        if(flag.init_ok && !flag.start)
//                        {
//                            Garage_T += 2;
//                        }
//                        if(road_type.barrier)
//                        {
//                            Barrier_T += 2;
//                        }
//                        if(road_type.Barn_l_in || road_type.Barn_r_in)
//                        {
//                            Stop_T += 2;
//                        }
//                    }
