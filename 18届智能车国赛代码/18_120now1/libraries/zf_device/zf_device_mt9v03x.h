...
#define MT9V03X_H               (64)                                           // 图像高度     范围 [1-480]

#define COLW                    (100)                                           // 原始：128  /*!< 屏幕显示宽度（用户使用）宽度 */
#define COLH                    (60)                                            // 原始：64  /*!< 屏幕显示高度（用户使用）高度 */
#define LCDW                    (100)                                           // 原始：128  /*!< 屏幕显示宽度（用户使用）宽度 */
#define LCDH                    (60)                                            // 原始：64  /*!< 屏幕显示高度（用户使用）高度 */
